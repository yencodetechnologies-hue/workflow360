...
//     siteName: '', contactName: '', contactPhone: '', siteAddress: '', password: '',
//   })
...
//     if (!confirm(`Deactivate ${b.siteName || b.contactPhone || 'this biller'}?`)) return
...
//       <Modal
//         open={editOpen}
//         title={editing ? `Edit ${editing.siteName || 'biller'}` : 'Edit biller'}
...
function KeyIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" width="16" height="16" aria-hidden>
      <path
        d="M15.5 8.5a3.5 3.5 0 1 0-3.36 3.49L9 15.13V17h-2v2H5v2H3v-3.59l6.04-6.04A3.5 3.5 0 0 1 15.5 8.5Z"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <circle cx="14.5" cy="8.5" r="0.6" fill="currentColor" stroke="none" />
    </svg>
  )
}
