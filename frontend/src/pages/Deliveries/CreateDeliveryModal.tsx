...
//   const [addProductForm,    setAddProductForm]    = useState({ name: '', sku: '', category: '', specification: '', rate: '', imagePath: '' })
...
//                       }, 0)
//                       setAddProductForm({ name: '', sku: `SKU-${maxSNo + 1}`, category: '', specification: '', rate: '', imagePath: '' })
...
//                             // Get picked product details for this godown
...
//                                 return { productId: l.productId, name: product?.particulars ?? l.productId, qty: l.qty }
//                               })
//                             return (
...
//                                       <div
//                                         key={pp.productId}
//                                         style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 4, background: '#ecfdf5', borderRadius: 6, padding: '3px 6px' }}
...
//                   if (activeGodownId) void loadGodownProducts(activeGodownId)
